...
import "./exodatoken-imports.sol";

/**
 * Exchanges may impose a limit on the total transaction fee (so that, for example, you cannot claim 100%).
 * Usually this is done by limiting the max value of slippage, for example, PancakeSwap max slippage is 49.9%
 * and the fees total of more than 35% will most likely fail there.
 */
abstract contract Tokenomics {
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY; // unlimited
    
    /**
     * Set the maximum allowed balance in a wallet.
     */
    uint256 internal constant maxWalletBalance = 0; // unlimited
     ...
     * 
     * 1% of each transaction will be first
     ...
     * and together with the other half converted into a EXODA-BNB LP Token.
     */
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    // Mainnet
    // PancakeSwap V2 = https://pancakeswap.finance/info
    ...
    /**
    * Sets the PancakeSwap pair (router & factory) for swapping and liquifying tokens
    */
     ...
     * 
     * The swapAndLiquify function converts half of the contractTokenBalance EXODA tokens to BNB. 
     * For every swapAndLiquify function call, a small amount of BNB remains in the contract. 
     ...
     * to withdraw these funds, and the BNB will be locked in the Exoda contract forever.
...
abstract contract ExodaToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract ExodaTokenV1 is ExodaToken{

    constructor() ExodaToken(Env.Mainnet){
